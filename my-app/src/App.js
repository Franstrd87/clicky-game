...
let guessedRight = 0;
let scoreToBeat = 0;
let selectedMsg = "select your favorite soccer club, don't select the same image twice";
...
class App extends Component {
  ...
  setClicked = id => {
    ...
    if (clickedMatch[0].clicked) {
      ...
      selectedMsg = "aye look at you! what a pro";
      scoreToBeat = 12;
      this.setState({ scoreToBeat });
  ...
  render() {
    return (
      <Wrapper>
        <Title>Click Your Favorite Soccer Club!</Title>
